...
const KAFKA_WRITER_PODCASTS = [
  {
    ...
    duration: "42 min",
    description:
      "A deep dive into Franz Kafka's most famous novella and its influence on existential literature.",
    imageUrl:
  ...
  },
  {
    ...
    duration: "35 min",
    description:
      "Exploring Kafka's relationship with absurdism, Camus, and 20th-century European thought.",
    imageUrl:
  ...
  },
  {
    ...
    duration: "50 min",
    description:
      "Tracing Kafka's life in Prague and how the city shaped his dark, surreal storytelling.",
    imageUrl:
...
const Index = () => {
  ...
  const simulateListening = useCallback(
    (nextStep: Step, setQuery: (q: string) => void, query: string) => {
            ...
            >
              <div>
                <h1 className="text-4xl md:text-5xl font-display font-bold text-foreground mb-3">
                  What do you want to{" "}
                  <span className="text-gradient">listen</span> to?
                </h1>
                <p className="text-muted-foreground max-w-md mx-auto">
                  Tap the mic and tell us a topic. We'll find the best podcasts
                  for you.
                </p>
              </div>
            ...
            >
              ...
              <div className="flex flex-col items-center gap-3 mt-4">
                <p className="text-xs text-muted-foreground">
                  Or refine your search by voice
                </p>
                <VoiceMic
                  isListening={false}
